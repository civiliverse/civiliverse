#!/usr/bin/env node
/**
 * Civiliverse · R5b 数据烘焙器（继承 R4a；R5 改动＝目标文件、no-op 退出码修复、informs/enables r2 端点扩展标记）
 ...
 *
 * 用法：node web/prototypes/r5b-bake-data.mjs [repoRoot]
...
const htmlPath = path.join(ROOT, "web/prototypes/civiliverse-r5b-proto.html");
